	...
	if (com_rslt == SUCCESS) {
		while(true) {
			...
			if (com_rslt == SUCCESS) {
	            ...
	            ssd1306_display_text(&dev, 0, temperature, 20, false);
				ssd1306_display_text(&dev, 2, pressure, 20, false);
				ssd1306_display_text(&dev, 4, humidity, 20, false);
